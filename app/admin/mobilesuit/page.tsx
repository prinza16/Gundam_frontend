...
import {
  Mobilesuit,
  MobilesuitRead,
  PaginatedResponseMobilesuit,
  PaginatedResponseMobilesuitRead,
...
const MobilesuitList = () => {
  ...
  const confirmDeleteMobilesuit = async () => {
    if (mobilesuitsToDeleteId === null) return;
    setLoading(true);
    setError(null);
    try {
  ...
  const handlePageChange = (pageNumber: number) => {
    if (pageNumber > 0 && pageNumber <= totalPages) {
      fetchMobilesuits(pageNumber, debouncedSearchQuery);
    }
  };
  ...
  return (
    <div className="w-full flex flex-col min-h-[calc(100vh-100px)] bg-gray-900 text-blue-100 p-6 rounded-lg shadow-x">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-blue-200">Mobile Suit</h1>
        <div className="flex items-center bg-blue-900">
          <input
            type="text"
            placeholder="Search..."
      ...
      {mobilesuits.length === 0 ? (
        ...
        <>
          <div className="flex-grow overflow-x-auto w-full container">
              ...
              <tbody>
                {mobilesuits.map((mobilesuit, index) => (
                  <tr key={mobilesuit.model_id}>
                    ...
                    <td className="whitespace-nowrap text-xl font-medium text-blue-200 text-center">
                      {mobilesuit.model_width}ซม. x {mobilesuit.model_length}ซม.
                      x {mobilesuit.model_height} ซม.
                    </td>
                    <td className="whitespace-nowrap text-xl font-medium text-blue-200 text-center">
                    ...
                    <td className="px-6 py-3 whitespace-nowrap text-xl font-medium text-blue-200 flex items-center justify-center">
                      ...
                      <button
                        ...
                        onClick={() =>
                          handleOpenDeleteModal(mobilesuit.model_id)
                        }
                      >
      ...
      <EditMobilesuitModal
        ...
        mobilesuitId={selectedMobilesuitsId}
        onMobilesuitUpdated={() =>
          fetchMobilesuits(currentPage, debouncedSearchQuery)
        }
      />
