...
const SellerList: React.FC = () => {
  ...
  const confirmDeleteType = async () => {
    if (sellerToDeleteId === null) return;
    setLoading(true);
    setError(null);
    try {
      const response = await fetch(
        `http://127.0.0.1:8000/gundam_data/seller/${sellerToDeleteId}/`,
        {
          method: "PATCH",
          headers: {
      ...
      const currentItemInPage = sellers.length;
                  ...
                  >
                    ...
                    <td className="px-6 py-3 whitespace-nowrap text-xl font-medium text-blue-200 flex items-center justify-center">
                      ...
                      <button
                        ...
                        onClick={() => handleOpenDeleteModal(seller.seller_id)}
                      >
